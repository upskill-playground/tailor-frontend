        ...
        <thead className=" bg-gray-800 w-full">
          <tr>
            {head.map((data, idx) => (
              <th
                key={`${data}+${idx}`}
                className="xl:py-3.5 px-2 py-5 text-left whitespace-nowrap capitalize text-gray-500 text-md font-normal xl:px-6"
              >
                {data}
              </th>
            ))}
        ...
        <tbody>
          {[...new Array(5)].map((_, idx) => (
            <tr key={idx} className="even:bg-gray-800  w-full  text-gray-100 ">
              <td className="px-2 whitespace-nowrap py-3.5 xl:px-6 xl:py-6 capitalize text-md xl:text-base font-medium">
                stanis baratheon
              </td>
              <td className="px-2 whitespace-nowrap py-5 xl:px-6 xl:py-6 text-md xl:text-base font-medium">
                stanis@mail.com
              </td>
              <td className="px-2 whitespace-nowrap py-5 xl:px-6 xl:py-6 text-md xl:text-base font-medium">
                7059606487
